        ...
        <div className="skill-right">
          ...
          <div className="skill-right-body certificates">
            <div className="skill-right-text">
              ...
              System Architect, High Tech Institute, The Netherlands (
              05/11/2021 )
            </div>
            <div className="skill-right-text">
              <FiberManualRecordIcon />
              Passive Damping for High Tech Systems, High Tech Institute (
              29/07/2021 )
            </div>
            <div className="skill-right-text">
              <FiberManualRecordIcon />
          ...
          <div className="skill-right-body patent">
            <div className="skill-right-text">
              <FiberManualRecordIcon />
              1704434 - Drilling System And Method Thereof ( 11/09/2020 ) (
              Taiwan )
            </div>
          </div>
        </div>
