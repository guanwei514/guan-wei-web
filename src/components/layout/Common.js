    ...
    const reload = () => {
        ...
        window.addEventListener("scroll", function () {
            ...
            if (top + h / 2 > skill && top + h / 2 < project) {
                ...
                document
                    .querySelector(".skill-bar-value1")
                    .classList.add("active");
                document
                    .querySelector(".skill-bar-value2")
                    .classList.add("active");
                document
                    .querySelector(".skill-bar-value3")
                    .classList.add("active");
                document
                    .querySelector(".skill-bar-value4")
                    .classList.add("active");
            } else {
